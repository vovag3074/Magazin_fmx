...
constructor TsdFastMemStream.Create(InitialCapacity: LongInt);
begin
  inherited Create;
...
function TsdBufferWriter.Read(var Buffer; Count: LongInt): Longint;
begin
  // not implemented
  raise Exception.Create('not implemented');
end;

function TsdBufferWriter.Write(const Buffer; Count: LongInt): Longint;
var
  Idx, Siz: integer;
begin
